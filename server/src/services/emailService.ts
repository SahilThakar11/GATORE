...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Gatore – Business Verification Code</title>
</head>
<body style="margin:0;padding:0;background-color:#faf8f4;font-family:Georgia,serif;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:40px 40px 32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
              ...
              <p style="margin:0 0 28px;font-family:Arial,sans-serif;font-size:15px;color:#4b5563;line-height:1.7;">
                You requested a verification code to access your <strong style="color:#111827;">Gatore Business Portal</strong>. Use the code below — it's valid for <strong style="color:#111827;">10 minutes</strong>.
              </p>
          ...
          <tr>
            <td style="background-color:#ffffff;padding:24px 40px 32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <p style="margin:0 0 4px;font-family:Arial,sans-serif;font-size:12px;color:#9ca3af;">Your Business Portal —</p>
                    <p style="margin:0;font-family:Georgia,serif;font-size:15px;font-weight:700;color:#111827;">Manage your café, reservations, and game library.</p>
                  </td>
                  <td align="right" style="white-space:nowrap;">
                  ...
                  <td align="right">
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="padding-left:16px;">
                          <a href="http://localhost:5173/pricing" style="font-family:Arial,sans-serif;font-size:11px;color:#9ca3af;text-decoration:none;">Pricing</a>
                        </td>
                        <td style="padding-left:16px;">
                          <a href="http://localhost:5173/contact" style="font-family:Arial,sans-serif;font-size:11px;color:#9ca3af;text-decoration:none;">Contact</a>
                        </td>
